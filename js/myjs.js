// Função para alertar que o Login Name não está disponível
function inv_login_name(){
	alert("       Nome de login já existe!\nEscolha outro nome para fazer login.");
	window.location.href = "quick.php";
}

// Funcao para abrir um POP-UP contendo o HTML informado no parâmetro
function abrir(URL) {
...
// Função para emitir mensagems temporizadas
...
function mostrarDialogo(mensagem, tipo, tempo){
    ...
    // se não setar o tempo, o padrão é 2 segundos
    if(!tempo){
        var tempo = 2000;
    }
