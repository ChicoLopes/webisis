#!/bin/bash
# ------------------------------------------------------------------------- #
# calc_date.sh - Calcula diferenca entre datas
# ------------------------------------------------------------------------- #
#      Entrada: <Data antiga> <Data nova>
#        Saida: mensagem
#     Corrente:
#      Chamada: calc_date.sh <Data antiga> <Data nova>
#      Exemplo: calc_date.sh 200720091025 200720091050
#  Comentarios: as datas deverao ter o formato DDMMAAAAhhmm
#
# Dependencias: esse script esta sendo utilizado com chkMxI.sh
#
#              --> chkMxI.sh
#                          |
#                          + calc_date.sh
