...
# ATENCAO: CISIS DEVE ESTAR NO PATH
# ------------------------------------------------------------------------- #
...
export CISIS_DIR=/usr/local/bireme/cisis/4.3a/lind

if [ "$#" -lt 1 -o "$#" -gt 2 ]
then
  TPR="fatal"
  MSG="use: dbstat <dbn> [ascii/ansi/ebcdic/flat]"
  . log
fi
...
mxf0 $1 create=stat $MAXMFN noedit
. log
...
mx stat pft=@1.pft -all now > $1.sta
. log
...
# Define conjunto de caracteres para analise
  ...
  then
        ...
        echo "  case '83': '  131  funcao de (math)'">>1.pft
        echo "  case '84': '  132 '">>1.pft
        echo "  case '85': '  133  elipse ()'">>1.pft
        echo "  case '86': '  134 '">>1.pft
        echo "  case '87': '  135 '">>1.pft
        echo "  case '88': '  136 '">>1.pft
        echo "  case '89': '  137  permill (0/00)'">>1.pft
        ...
        echo "  case '91': '  145  Apostrofe esq '">>1.pft
        echo "  case '92': '  146  Apostrofe dir '">>1.pft
        #REM                       123456789012345678
        echo "  case '93': '  147  Aspas esq (tipog)'">>1.pft
        echo "  case '94': '  148  Aspas dir (tipog)'">>1.pft
        echo "  case '95': '  149 '">>1.pft
        echo "  case '96': '  150  travessao curto'">>1.pft
        echo "  case '97': '  151  travessao lonog'">>1.pft
        echo "  case '98': '  152  tilde'">>1.pft
        echo "  case '99': '  153  Trade mark'">>1.pft
        echo "  case '9a': '  154  S w/caron'">>1.pft
        echo "  case '9b': '  155  >'">>1.pft
        echo "  case '9c': '  156  oe'">>1.pft
        echo "  case '9d': '  157 '">>1.pft
        echo "  case '9e': '  158 '">>1.pft
        echo "  case '9f': '  159  Y com trema'">>1.pft
        ...
        echo "  case 'a4': '  164  Cifrao'">>1.pft
        echo "  case 'a5': '  165  YENE'">>1.pft
        echo "  case 'a6': '  166  Pipe'">>1.pft
        ...
        echo "  case 'ac': '  172  NOT'">>1.pft
        echo "  case 'ad': '  173  soft hiphen'">>1.pft
        echo "  case 'ae': '  174  REGISTRADA'">>1.pft
        echo "  case 'af': '  175  macron'">>1.pft
        echo "  case 'b0': '  176  GRAUS'">>1.pft
        echo "  case 'b1': '  177  +/-'">>1.pft
        echo "  case 'b2': '  178  A SEGUNDA'">>1.pft
        echo "  case 'b3': '  179  A TERCEIRA'">>1.pft
        echo "  case 'b4': '  180  acento agudo'">>1.pft
        echo "  case 'b5': '  181  micro'">>1.pft
        echo "  case 'b6': '  182  Pilcrow'">>1.pft
        echo "  case 'b7': '  183 '">>1.pft
        echo "  case 'b8': '  184  cedilha'">>1.pft
  ...
  then
        ...
        echo "  case '3e': '   62  MAIOR'">>1.pft
        #REM                       123456789012345678
        echo "  case '3f': '   63  INTERROGACAO'">>1.pft
        echo "  case '40': '   64  @'">>1.pft
        echo "  case '41': '   65  A'">>1.pft
        echo "  case '42': '   66  B'">>1.pft
        echo "  case '43': '   67  C'">>1.pft
        ...
        echo "  case '83': '  131  a circunflexo'">>1.pft
        ...
        #REM                       123456789012345678
        echo "  case '93': '  147  o circunflexo'">>1.pft
        echo "  case '94': '  148  o trema'">>1.pft
        echo "  case '95': '  149  o grave'">>1.pft
        echo "  case '96': '  150  u circunflexo'">>1.pft
