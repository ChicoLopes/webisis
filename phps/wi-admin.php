<?php
	 ...
	 */
	session_cache_expire(TIMSESSION);	// Tornar configuravel
	session_start();
...
<html lang="pt-br">
<head>
	<title>Administração | <?php echo APLICACAO;?> [QAPLA]</title>
	...
	<!-- Para uso da versão 5 do Font Awesome -->
	...
	<header>
		<div class="container">
			...
			<div id="menu">
				...
				<nav class="menu">
					<ul>
						<li><a href="/phps/wi-admin.php">Home</a></li>
<!--
						...
						<li><a href="#">Relatórios</a>
							<ul>
<?php include("phps/relatorios.inc.php"); ?>
							</ul>
						</li>
						<li><a href="#">Ferramentas</a>
							<ul>
<?php include("phps/tools.inc.php"); ?>
							</ul>
						</li>
-->
					</ul>
