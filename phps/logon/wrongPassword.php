...
<html lang="pt-br">
<head>
	<title>ErrPassword | WebISIS [QAPLA]</title>
	...
	<section>
		<div class="container">
			<div class="formlogin">
				...
				<div class="link">
					<p>
					Tentar<br><br><a href="<?php echo $pg_start ?>">login novamente!</a></p>
				</div>
				<div class="link">
					<p>Esqueceu o username?<br><br>
					<a href="phps/recupera.php">Recuperar pelo e-mail</a></p>
				</div>
			</div>
		</div>
	</section>
